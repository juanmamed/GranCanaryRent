...
public class AñadirTarjeta extends javax.swing.JFrame {
    ...
    public AñadirTarjeta(GranCarnaryRent granCarnaryRent, Usuario usuario) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AñadirTarjeta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AñadirTarjeta().setVisible(true);
            }
        });
    }
